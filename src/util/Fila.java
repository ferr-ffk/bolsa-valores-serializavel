...
class Celula<T> implements Serializable {

	@Serial
	private static final long serialVersionUID = -4235458849570785163L;
	T coisa;
...
public class Fila<T> implements Serializable {
	...
	@Serial
	private static final long serialVersionUID = 2185806383638235817L;
	/**
	 * O tamanho da fila
	 */
	private int tamanho;
